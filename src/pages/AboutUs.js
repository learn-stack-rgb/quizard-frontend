...
const AboutUs = () => {
    ...
    return(
        <div className="divAll">
            ...
            <div className="divR">
                <h3 className="h31">Raquel King</h3>
                <h3 className="h31">Design Lead</h3>
                <h4 className="h41">Austin, TX</h4>
            ...
            <div className="divG">
                <h3 className="h32">Graham Blundell</h3>
                <h3 className="h32">Product Manager & Project Manager</h3>
                <h4 className="h42">San Diego, CA</h4>
                <span className="spanny">
            ...
            <div className="divB">
                ...
                <h4 className="h43">San Diego, CA</h4>
                <span className="spanny">
